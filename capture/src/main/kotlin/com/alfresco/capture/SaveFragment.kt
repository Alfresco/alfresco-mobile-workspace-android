...
class SaveFragment : Fragment(), MavericksView {
    ...
    private fun setListeners() {
        binding.fileNameInputLayout.editText?.addTextChangedListener(
            object : TextWatcher {
        ...
        binding.descriptionInputLayout.editText?.addTextChangedListener(
            object : TextWatcher {
                override fun beforeTextChanged(
                    s: CharSequence?,
                    start: Int,
    ...
    private fun validateName(name: String) {
        ...
        binding.fileNameInputLayout.error =
            when {
    ...
    private fun setSaveButtonState(isVisibleFieldValid: Boolean) =
        withState(viewModel) {
    ...
    private fun showPreview(captureItem: CaptureItem?) =
        withState(viewModel) {
