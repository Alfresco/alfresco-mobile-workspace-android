...
data class DeletedNode(
    ...
    @Json(name = "archivedByUser") @field:Json(name = "archivedByUser") var archivedByUser: UserInfo,
    @Json(name = "archivedAt") @field:Json(name = "archivedAt") var archivedAt: ZonedDateTime,
