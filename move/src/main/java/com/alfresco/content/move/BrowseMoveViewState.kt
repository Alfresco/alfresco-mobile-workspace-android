...
data class BrowseMoveViewState(
    val path: String,
    val nodeId: String?,
    ...
    constructor(args: BrowseMoveArgs) : this(args.path, args.id)
    ...
    fun updateUploads(uploads: List<Entry>): BrowseMoveViewState {
     ...
     */
    fun updateTransferUploads(uploads: List<Entry>): BrowseMoveViewState {
    ...
    private fun defaultReducer(newEntries: List<Entry>): BrowseMoveViewState =
        copy(
            entries = newEntries
        )

    @RequiresApi(Build.VERSION_CODES.O)
    private fun groupByModifiedDateReducer(newEntries: List<Entry>): BrowseMoveViewState {
