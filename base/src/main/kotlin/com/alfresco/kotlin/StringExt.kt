...
fun String.ellipsize(length: Int) =
    if (this.length <= length) {
        ...
        this.subSequence(0, length).toString().plus("\u2026")
    }
...
fun String.filename() = Uri.parse(this).lastPathSegment

fun String.parentFile(): File? = File(Uri.parse(this).path ?: "").parentFile
