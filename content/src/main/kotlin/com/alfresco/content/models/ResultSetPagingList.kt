...
data class ResultSetPagingList(
    @Json(name = "pagination") @field:Json(name = "pagination") var pagination: Pagination? = null,
    @Json(name = "context") @field:Json(name = "context") var context: ResultSetContext? = null,
    @Json(name = "entries") @field:Json(name = "entries") var entries: List<ResultSetRowEntry>? = null
)
