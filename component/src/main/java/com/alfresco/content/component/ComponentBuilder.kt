...
data class ComponentBuilder(
     ...
     */
    fun onApply(callback: ComponentApplyCallback?) = apply { this.onApply = callback }

    /**
     * Filter sheet reset callback
     */
    fun onReset(callback: ComponentResetCallback?) = apply { this.onReset = callback }

    /**
     * Filter sheet cancel callback
     */
    fun onCancel(callback: ComponentCancelCallback?) = apply { this.onCancel = callback }
