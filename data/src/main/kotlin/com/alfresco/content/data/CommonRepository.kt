...
class CommonRepository(val session: Session = SessionManager.requireSession) {
    private val fileMenuSingleActions =
        listOf(
    ...
    private val fileMenuMultiActions =
        listOf(
    ...
    private val folderMenuSingleActions =
        listOf(
            MenuActions.AddFavourite,
            MenuActions.RemoveFavourite,
            MenuActions.Rename,
    ...
    private val folderMenuMultiActions =
        listOf(
            MenuActions.AddFavourite,
            MenuActions.RemoveFavourite,
            MenuActions.Move,
    ...
    fun isAllMultiActionsEnabled(
        serverList: List<AppMenu>?,
        ...
        if (hasTrashedFilesFolders) {
            val enabledActions =
                trashMenuActions.filter { menuAction ->
            ...
            val enabledActions =
                fileMenuMultiActions.filter { menuAction ->
                    serverList?.any { it.id.equals(menuAction.value(), ignoreCase = true) && it.enabled } == true
                }
            list.addAll(enabledActions)
            return list.isNotEmpty()
            ...
            val enabledActions =
                folderMenuMultiActions.filter { menuAction ->
                    serverList?.any { it.id.equals(menuAction.value(), ignoreCase = true) && it.enabled } == true
                }
            list.addAll(enabledActions)
            return list.isNotEmpty()
    ...
    fun isAllSingleActionsEnabled(
        ...
        if (entry.isTrashed) {
            ...
            val enabledActions =
                fileMenuSingleActions.filter { menuAction ->
                    serverList?.any { it.id.equals(menuAction.value(), ignoreCase = true) && it.enabled } == true
                }
            list.addAll(enabledActions)
            return list.isNotEmpty()
            ...
            val enabledActions =
                folderMenuSingleActions.filter { menuAction ->
                    serverList?.any { it.id.equals(menuAction.value(), ignoreCase = true) && it.enabled } == true
                }
            list.addAll(enabledActions)
            return list.isNotEmpty()
